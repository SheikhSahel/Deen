...
type BookChapter = {
  chapterTitle: string;
  books: Array<{ title: string; content: string }>;
};

const BOOK_CHAPTERS: readonly BookChapter[] = [
  {
    chapterTitle: "হজ্ব অধ্যায়",
    books: [
      { title: "হজ্বের সংজ্ঞা ও প্রকারভেদ", content: "হজ্বের ফরজ, ওয়াজিব, সুন্নত, হজ্বের প্রকারভেদ (ইফরাদ, কিরান, তামাত্তু) এবং করণীয়-বর্জনীয়ের সংক্ষিপ্ত ও প্রয়োগভিত্তিক আলোচনা।" },
      { title: "মীকাত পরিচয় ও গুরুত্ব", content: "কোন দেশের যাত্রী কোন মীকাত থেকে ইহরাম বাঁধবেন, মীকাত অতিক্রমের আগে প্রস্তুতি এবং মীকাত সংক্রান্ত সাধারণ ভুল।" },
      ...
      { title: "উকুফ এবং দাঁড়ানোর আমল", content: "উকুফের গুরুত্ব, নির্ধারিত সময়, দোয়া ও ইস্তিগফারের আমল এবং উকুফ গ্রহণযোগ্যতার শর্ত।" },
      { title: "মিনায় অবস্থান", content: "মিনায় অবস্থানের দিনভিত্তিক পরিকল্পনা, তাঁবু-শৃঙ্খলা, জামাতে নামাজ এবং নিরাপত্তা-সংক্রান্ত দিকনির্দেশনা।" },
      { title: "আরাফার ময়দান", content: "৯ জিলহজে আরাফার ময়দানে সবচেয়ে গুরুত্বপূর্ণ আমল, খুতবা শোনা, দোয়ার আদব এবং সময় ব্যবস্থাপনা।" },
      { title: "মুজদালিফায় রাত্রিযাপন", content: "মাগরিব-এশা একসাথে আদায়, কঙ্কর সংগ্রহ, রাত যাপন, ফজর পরবর্তী আমল এবং মিনায় ফেরত যাত্রা নির্দেশনা।" },
      { title: "কঙ্কর নিক্ষেপ (রমি)", content: "জামরাতের ধাপ, সময়সীমা, কঙ্কর নিক্ষেপের সুন্নত পদ্ধতি, ভিড় ব্যবস্থাপনা ও নিরাপত্তা টিপস।" },
      { title: "পাপের কাফফারা (জিনায়াত)", content: "অপরাধের কারণে দম দিতে হবে কি না, কোন ভুলে কী প্রতিকার, সাদাকা বা কাযা লাগার বাস্তব উদাহরণসহ ব্যাখ্যা।" },
    ],
  },
  {
    chapterTitle: "মীকাত অধ্যায়",
    books: [
      { title: "বদলী হজ্ব", content: "অন্যের পক্ষ থেকে হজ্ব করার শর্ত, নিয়ত, অনুমতি, আর্থিক সক্ষমতা এবং ফিকহি সীমারেখা।" },
      { title: "হাদি এবং কুরবানি", content: "হাদি কাদের উপর ওয়াজিব, কুরবানি ব্যবস্থাপনা, কুপন সিস্টেম, বিকল্প ব্যবস্থা এবং সময়সূচী।" },
      { title: "হলক এবং তাকসির", content: "মাথা মুণ্ডন/চুল ছোট করা (হলক/তাকসির) বিধান, পুরুষ-মহিলার পার্থক্য এবং সঠিক সময়।" },
      { title: "উমরা সম্পাদন প্রক্রিয়া", content: "উমরার পূর্ণ ধাপ: ইহরাম, তাওয়াফ, সায়ি, হলক/তাকসির; স্বল্প সময়ে পরিকল্পিতভাবে উমরা সম্পাদন।" },
      { title: "মহিলাদের বিশেষ মাসায়েল", content: "মহিলাদের ইহরাম, মাহরাম, হায়েজ/নেফাস অবস্থায় আমল, তাওয়াফ/সায়ির বিধান এবং ব্যবহারিক প্রশ্নোত্তর।" },
      { title: "মক্কায় অবস্থান ও দর্শনীয় স্থান", content: "মক্কায় গুরুত্বপূর্ণ স্থান, হারাম শরীফে আদব, ভিড়ের সময় চলাচল, পানি/স্বাস্থ্য ও অবস্থান ব্যবস্থাপনা।" },
      { title: "হারামাইনে নামাজের আহকাম", content: "মসজিদুল হারাম ও মসজিদে নববীতে জামাত, সাফ, ইমামের অনুসরণ, কসর/জমা ও বাস্তব সমস্যার সমাধান।" },
      { title: "মদিনা জিয়ারত এবং উপহার স্থানসমূহ", content: "রওজা জিয়ারত আদব, মসজিদে নববীর আমল, কুবা/উহুদ জিয়ারত এবং আচরণবিধি।" },
      { title: "যাত্রা পরিকল্পনা এবং নিরাপত্তা", content: "ভ্রমণ নথিপত্র, স্বাস্থ্য প্রস্তুতি, গ্রুপ সমন্বয়, জরুরি নম্বর, আর্থিক নিরাপত্তা এবং সফর শৃঙ্খলা।" },
      { title: "হজ্বের সম্পূর্ণ সারসংক্ষেপ", content: "হজ্বের পুরো ফ্লো এক পৃষ্ঠায়: দিনভিত্তিক কাজ, ফরজ-ওয়াজিব চেকলিস্ট এবং দ্রুত রিভিশন নোট।" },
      { title: "উমরা সারসংক্ষেপ", content: "উমরার ধাপগুলো ক্রমানুসারে চেকলিস্ট আকারে: কী আগে, কী পরে এবং সাধারণ ভুল এড়ানোর টিপস।" },
      { title: "হজ্ব ও উমরার দোয়া সমূহ", content: "প্রতিটি পর্যায়ে দরকারি সংক্ষিপ্ত দোয়া, উচ্চারণ-সহায়তা ও প্রেক্ষিতভিত্তিক ব্যবহারের নির্দেশনা।" },
    ],
  },
] as const;
...
const NEW_MOON_DUA = {
  arabic:
    "اللّٰهُ أَكْبَرُ، اَللّٰهُمَّ أَهِلَّهُ عَلَيْنَا بِالْأَمْنِ وَالْإِيْمَانِ وَالسَّلَامَةِ وَالْإِسْلَامِ، وَالتَّوْفِيْقِ لِمَا تُحِبُّ وَتَرْضَى، رَبُّنَا وَرَبُّكَ اللّٰهُ",
  pronunciation:
